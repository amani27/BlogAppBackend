...
Route::group(
    ...
    function () {
        ...
        // Route::get('/allBlogsByCategory/{category_id}', 'BlogController@getBlogsByCategory');
        // Route::get('/allBlogsByCategories/{category_id}', 'BlogController@getBlogsByCategories');
